...
/* user/show.html.twig */
class __TwigTemplate_8e02a5193fef3818aad7d54833a14e9c9b1c21c257e659290b54bd3e8f8b8245 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 28
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 28, $this->source); })()), "pieces", [], "any", false, false, false, 28), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "user/show.html.twig", "C:\\Users\\tthan\\ProjetPokegame\\templates\\user\\show.html.twig");
    }
}

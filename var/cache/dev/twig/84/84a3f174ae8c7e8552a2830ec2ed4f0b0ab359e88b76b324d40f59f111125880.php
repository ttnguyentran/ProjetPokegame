...
class __TwigTemplate_43ef73062a5d4a0603a63719513ab1cad957ea1acbe633f7f4da070881bdda0b extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"jumbotron\">
        <h1>Bienvenue sur PokéGame 2020 !</h1>
\t\t";
        // line 9
...
\t\t\t\t<a href=\"";
            ...
            echo "\" class=\"btn btn-primary btn-lg\">Créer un compte</a>
\t\t\t\t<a href=\"";
            // line 12
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_login");
            echo "\" class=\"btn btn-default\">Se connecter</a>
\t\t\t</p>
\t\t\t
\t\t";
...
(isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 15, $this->source); })()), "user", [], "any", false, false, false, 15)) {
            // line 16
            echo "\t\t\t<p>
\t\t\t\t<h5>Connecté(e) en tant que <span class=\"badge badge-pill badge-primary\">";
            // line 17
...
\t\t\t\t<h5><span class=\"badge badge-pill badge-primary\">";
            // line 18
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 18, $this->source); })()), "user", [], "any", false, false, false, 18), "pieces", [], "any", false, false, false, 18), "html", null, true);
            echo "</span> PokePièce(s)</h5>
\t\t\t</p>
\t\t
\t\t";
        }
...
";
    ...
    {
        return array (  124 => 21,  117 => 18,  113 => 17,  110 => 16,  108 => 15,  102 => 12,  98 => 11,  95 => 10,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
\t\t\t\t<a href=\"{{ path('app_login') }}\" class=\"btn btn-default\">Se connecter</a>
\t\t\t</p>
\t\t\t
\t\t{% elseif app.user %}
\t\t\t<p>
\t\t\t\t<h5>Connecté(e) en tant que <span class=\"badge badge-pill badge-primary\">{{ app.user.username }}</span></h5>
\t\t\t\t<h5><span class=\"badge badge-pill badge-primary\">{{ app.user.pieces }}</span> PokePièce(s)</h5>
\t\t\t</p>
\t\t
\t\t{% endif %}\t
    </div>
